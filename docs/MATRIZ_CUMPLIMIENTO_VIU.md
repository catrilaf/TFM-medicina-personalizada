...
| Declaración del uso de IA | Cumple, confirmada por el autor | La memoria y `docs/REGISTRO_USO_IA.md` declaran ChatGPT, Claude, Gemini y Codex, con alcance, límites y verificaciones. El autor confirmó las herramientas y versiones declaradas; el registro distingue las versiones no acreditadas mediante logs. |
